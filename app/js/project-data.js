...
Format:
	...
	img : '',		// 400 * 250					// image to display
	tech : ['','','','','']						// Technologies/skills used, HTML, CSS, PHP, WordPress, React.js etc
*/
...
var p = (function () {				// eslint-disable-line
	...
	var projects = [
	{
		name: 'Silverstreet\'s Cloud Portal',
		description : 'Over the course of a year, I worked as part of the Silverstreet team, collaborating with the graphic design and backend development team to further develop the customer portal, a portal that clients can use to manage their authentication and send communication campaigns.<br>I led the migration from React v15 and Webpack 1 to React v16 and Webpack 4 for this and several other projects. Main work includes creating the campaign module using <a href="https://draftjs.org/" target="_blank">Draftjs</a>, <a href="https://reacttraining.com/react-router" target="_blank">React Router V4</a> and <a href="https://material-ui.com" target="_blank">Material UI</a> components to send SMS or number lookup campaigns. I\'ve enhanced the sign-up process, migrating it from individual blocks of code, some in jQuery and HTML, to one main React module and included Google Analytics to track progress.<br>Another larger addition to the code base was adding credit card validation for new payments using webRTC and use the users\' webcam.',
		url: ['https://www.twizo.com'],
		img : '',
		tech : ['React','Material UI', 'DraftJS', 'React Router V4', 'Redux','API', 'PHP', 'Twig'],
		category : ['featured', 'react', 'api']
	},{
		name: 'Brilliant Massage Therapy',
		description : 'This is a client project in which I merged two sites into one in collaboration with Andrew from <a href="http://www.thinkupdesign.ca" target="_blank">ThinkUp Design</a>. After having done market research regarding local massage businesses and competing WordPress templates, we presented the client with the possible designs. The <a href="https://jacqueline.themerex.net" target="_blank">Jacqueline theme</a> was chosen.<br/> I migrated the current blog to a new WordPress site and installed the theme. After having styled most of the content and the revolution slider, Andrew took care of the intricate design fixes. The final result; a professional, SEO optimised, mobile ready and visual appealing site.',
...
// There's a better way to add elements to the page. See the below two examples
